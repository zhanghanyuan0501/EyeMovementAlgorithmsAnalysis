...
\begin{figure}[H]
    ...
    \small(źródło: \cite{eoptyczne} [dostęp 26.10.2019])}
    \label{fig:czopki}
\end{figure}
...
\begin{figure}[H]
    ...
    \small(źródło: \cite{eszkola} [dostęp 01.10.2019])}
    \label{fig:budowaoka}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption[Soczewki kontaktowe]{Soczewki do wykrywania ruchu oka.\\\hspace{\textwidth}
    \small(źródło: \cite{lenses} [dostęp 10.09.2019])}
    \label{fig:soczewki}
\end{figure}
...
\begin{figure}[H]
    ...
    \small(źródło: \cite{Tobii} [dostęp 01.10.2019])}
    \label{fig:cameras}
\end{figure}
...
\begin{figure}[H]
    ...
    \small(źródło: \cite{fiksacje} [dostęp 10.09.2019])}
    \label{fig:fiksacje}
\end{figure}
